...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Picture = __webpack_require__(/*! ./Picture */ 229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../public/css/picture.css */ 230);
	
	var _ColorDisplay = __webpack_require__(/*! ./ColorDisplay */ 232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./picture.css */ 231);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 221)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(/*! !./../../~/css-loader!./picture.css */ 231, function() {
				var newContent = __webpack_require__(/*! !./../../~/css-loader!./picture.css */ 231);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
