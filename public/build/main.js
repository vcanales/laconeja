...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#signup,#login{display:flex;justify-content:center;flex-direction:column;align-items:center}#signup form .input,#login form .input{margin:1rem}#signup form .input input,#login form .input input{background-color:rgba(255,238,220,0.1);border:none;border-bottom:1px solid #FFEEDC;color:#FFEEDC;padding:10px;font-family:\"BariolRegular\",sans-serif;font-size:1rem}#signup form .input input:focus,#login form .input input:focus{outline:none}#signup form .input input[type=submit],#login form .input input[type=submit]{border:1px solid #FFEEDC;padding:10px}", ""]);
